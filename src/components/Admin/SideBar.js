...
import { Title, Flex, Divider, Text, Stack } from "@mantine/core";
import {
...
const SideBar = (props) => {
  ...
  return (
    ...
    >
      <Title mt={30} ml={20} mb={30}>
        <Flex gap={10} justify="flex-start" direction="row" wrap="nowrap">
          <svg
            style={{ minWidth: "calc(3rem* var(--mantine-scale))" }}
      ...
      >
        ...
        <SubMenu
          label="Features"
          icon={<IconAdjustmentsFilled size={18} stroke={1.5} />}
          rootStyles={{
            ["." + menuClasses.subMenuContent]: {
              backgroundColor: "#aaa",
            },
      ...
      >
        <Divider c="#141414" size="xs" my="20" opacity={0.6} />
        <Text ta="center" c="#fff" fz={{ base: 12 }} mb={20}>
